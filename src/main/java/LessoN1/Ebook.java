...
public class Ebook implements Book {
    ...
    //@Override вказує, що цей метод перевизначає метод з інтерфейсу BookStore.
    ...
    //Підсумок
    //✅ Клас Ebook є підтипом BookStore (поліморфізм через інтерфейс).
    //✅ Метод displayInfo() перевизначений для конкретної поведінки електронної книги.
    //✅ Об'єкти Ebook можна використовувати як BookStore, що дозволяє працювати з різними книгами через один інтерфейс.
